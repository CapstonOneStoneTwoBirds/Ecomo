package onestonetwobirds.capstonuitest3.groupHouseKeeping;
 ...
 */
public class GroupActivity extends ActionBarActivity implements ToolbarManager.OnToolbarGroupChangedListener {
    ...
    class DrawerAdapter extends BaseAdapter implements View.OnClickListener {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (v == null) {        // 클릭된 값이 없을 경우
                v = LayoutInflater.from(GroupActivity.this).inflate(R.layout.row_drawer, null);
            ...
            if (tab == mSelectedTab) {           // 한개의 내용만 tab과 일치하여 if에 들어가고 나머지는 else (클릭된 리스트 내용)
                v.setBackgroundColor(ThemeUtil.colorPrimary(GroupActivity.this, 0));
