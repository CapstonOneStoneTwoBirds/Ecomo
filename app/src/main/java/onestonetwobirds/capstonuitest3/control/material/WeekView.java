...
public class WeekView extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, onestonetwobirds.capstonuitest3.R.styleable.WeekView, defStyleAttr, defStyleRes);

        mVerticalPadding = a.getDimensionPixelOffset(onestonetwobirds.capstonuitest3.R.styleable.WeekView_wv_verticalPadding, ThemeUtil.dpToPx(context, 8));
        mHorizontalPadding = a.getDimensionPixelOffset(onestonetwobirds.capstonuitest3.R.styleable.WeekView_wv_horizontalPadding, ThemeUtil.dpToPx(context, 8));
        int animDuration = a.getInteger(onestonetwobirds.capstonuitest3.R.styleable.WeekView_wv_animDuration, context.getResources().getInteger(android.R.integer.config_mediumAnimTime));
        mBackgroundColors = a.getColorStateList(onestonetwobirds.capstonuitest3.R.styleable.WeekView_wv_backgroundColor);
